...
**Q:** Winamp2.js is really awesome! It really brings me back <3. Do you have any plans of maybe turning it in to an electron app so it can run natively? :smiley: - Gabe
...
**Q:** Maybe this is a dumb question, but why do you choose winamp? - AdrianC
...
**Q:** Do you expect Nuclide and Atom IDE to exist side-by-side or do you think one will supercede the other? - ckknight
...
**Q:** What was the major challenge you faced while working on winamp2? - Karma7
...
**Q:** Any plans to have nuclide support for VSCode? I understand that could take significant efforts including rewrite. - dhruvdutt
...
**Q:** I would like to write a blog and articles too, but I don't know how to start. Do you have any advice for me? - AdrianC
...
**Q:** Will there be more documentation in the future on how to write plugins for Nuclide? I tried writing a plugin once and never got really far with it because I found myself diving more into the source than being able to read docs on how architecture is built for it. - lifeiscontent
...
**Q:** Can you talk about your typical day at work? What's the work/life balance at? What self-development opportunities does FB offer? - BTM
...
**Q:** I am new to React, been trying to learn and to get a job related to it, recently I am finding it hard to implement while learning, any suggestions? - Arun
...
**Q:** How did you manage your free time to work on this impressive side project? - cluk3
...
**Q:** Facebook obviously highly values modern libraries and web technologies but we all know the tech industry changes incredibly quickly. What do you expect will be the next major shift in in tech industry? - Llaver
...
**Q:** What tips would you give to a student going into college to study computer science and applying to internships? - Ron
...
**Q:** Could you share us some good habit what do you have?? - AdrianC
...
**Q:** What are suggestion for beginners to make their career to Facebook specially for those who are not living in USA? - Shoaib
...
**Q:** What do you study at school? Where? - AdrianC
...
**Q:** One thing you wish you knew before starting winamp2-js project - cluk3
...
**Q:** How did you go from classical voice to a career in programming? - Juanus
...
**Q:** What are some of the new WebBrowser APIs you are looking forward to? - lokiiarora
...
**Q:** What was your first program language and are you learning a new language? if yes which one? - AdrianC
...
**Q:** You mentioned you didn’t go to school for CS, why did you make that decision? I’m 17 yrs old, 3 yrs of frontend exp, and the question of going to college or maybe doing a boot camp instead has been on my mind. Do you have any tips or suggestions? :smiley: - Jett
...
**Q:** What do you believe would be the best path to finding a career at a high valued company as a 16 year old with no industry experience but many side projects? - reallypan
...
**Q:** When you started the winamp-js project, did you know that there was still a large community out there using Winamp? Or did that come as a surprise? - Juanus
...
**Q:** What is your favourite IDE and tech stack right now?? - AdrianC
...
**Q:** There are a few people I follow, look up to for inspiration/motivation, and just generally enjoy everything they do. Who is your hero? Who would you suggest I follow? Developer or non-developer :smiley: - g33kidd
...
**Q:** What do you feel like is the most underrated/underutilized ES6 feature? - Aetheryx
...
**Q:** What advice will you to give to someone starting a company? - lewatt23
...
**Q:** What’s one piece of advice you’ve been given that has stuck with you? - chelseahollow
...
**Q:** Do you sing yet? where can we hear you? :p - AdrianC
...
**Q:** What's your opinion on the HHVM vs Zephir vs Swoole articles/benchmarks currently around at the moment? - Sentinel
