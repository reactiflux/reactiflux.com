...
**Q:** What’s the status on adding a field like \_\_id to the GraphQL specification?
...
**Q:** Whats it like working on three of Facebook's biggest externally used software developer projects?

**A:** Busy! But a lot of fun

---

**Q:** Do you have any interesting insights on the differences between Falcor and GraphQL?
...
**Q:** Do you know of any resources available for hooking graphql up with websockets?
...
**Q:** Is data normalization something you are thinking about for GraphQL considering clients are manually normalizing data (e.g. Relay and Apollo)?
...
**Q:** What happened to your ecmascript proposals for immutable data-structures? Any chance you'll champion them again?
...
**Q:** A react+relay+flow project ends up using 3 incompatible type systems – flow, graphql types, and react proptypes; do you have any advice on how to optimally deal with this?
...
**Q:** Is there any application in production (Facebook or not) whose architecture you may describe as an Immutable app architecture?
...
**Q:** Are there any new personal-projects or facebook-projects you are working on that you are excited about?
...
**Q:** Where do you see React and React Native going?
...
**Q:** How far would you go building mobile app using react-native?

**A:** I'm not sure I understand the question but I would go as far as to build mobile apps in react-native 😃

---

**Q:** Relay transpiles queries to add an id field, as this is a feature that could be useful to many GraphQL clients, may GraphQL ever auto-inject an id field on supporting composite types?
...
**Q:** Is camera, gallery, and voice API's for react-native ever going to come? They seem like some of the things that most apps use in some way but react-native doesn't have those features in the API without using 3rd party.
...
**Q:** Is explicit null still on the horizon for graphql? what about map types?
...
**Q:** I vagely remember having stumbled upon some github comment that stated you are working on an open source Hack implementation of the GraphQL engine. Is this something you know anything about?
...
**Q:** Speaking to iOS development, can you recommend open source libraries that can be used to apply the same principles used in react, redux to native (swift or ObjC)?
...
**Q:** Any good compsci books you recommend reading?
...
**Q:** For advanced graphql features like \@batch and \@defer, is the path to get them in open-source graphql for the community to contribute PRs? if so, are there more detailed resources for how they should work, beyond your react europe talk?
...
**Q:** It seems like the Facebook projects you have the most influence on (GraphQL, ImmutableJS) have a very different coding style than codebases like React, React Native, and Relay which are all have similar styles. How does your coding style differ from that of Facebook’s?
...
**Q:** Hack graphql again | Do you know if it will be a completely new kind of API or resemble the graphql-js quite nicely?
...
**Q:** Where do you go (blogs, videos, etc.) to learn new things and get new ideas about programming?
...
**Q:** I'm curious on the topic of caching GraphQL results, specifically on the server-side or in-between as a proxy. Any thoughts/projects that come to mind, or best practices from FB?
...
**Q:** Are you guys planning to completely rewrite the Facebook mobile app with React Native?
...
**Q:** Any chance you can add a few simple examples to GraphQL + Data loader?  Its kind of hard to follow the SWAPI data-loader usage.
...
**Q:** So, is data loader more applicable to Relay being that it's used for fetching the data from the server and GraphQL is simply the mechanism for query the data from the GraphQL server?
...
**Q:** How do you scale the GraphQL API at Facebook?*
...
**Q:** To what extent is GraphQL used on the "main" Facebook app (facebook.com)?
...
**Q:** What kind of insights do you provide developers at Facebook when developing GraphQL related code? (e.g. performance of certain types of queries, fields that are never queried, etc.)
...
**Q:** How often is the GraphQL API the performance bottleneck at Facebook?
...
**Q:** Is that dangerous though, say if the handshake failed?
...
**Q:** What about from a DDOS perspective?
...
**Q:** You recently gave a talk about possible solutions for subscriptions or 'live queries' in GraphQL. Could you roughly estimate when one of those possible approaches will be implemented in graphql-js and Relay ?
...
**Q:** Any chance the data-loader functionality will be embedded into graphql so that we don't have to wire it up manually?
...
**Q:** How important is GraphQL parsing speed, or are query documents at Facebook cached?
...
**Q:** Have you seen implementations of GraphQL servers getting downstream data from another GraphQL-based service? Any concerns you can see with that type of approach? Maybe a lack of transparency of what's happening behind the scenes.
...
**Q:** How do you handle graphql query-to-request batching internally?
...
**Q:** Do you know anything about the new mutations API the seems to be in the works for Relay? I can find lots of references to it in the meta docs, but not many links to stuff that can tell me in which direction it is heading.
...
**Q:** What upcoming or in-development GraphQL change are you most excited about?
...
**Q:** Do you think theres room for GraphQL Client with small API surface?
...
**Q:** I'm building a graphql api with subscription support that uses websocket or equivalent. would you recommend sending normal queries and mutations via normal http, or should those go over the websocket as well?
...
**Q:** (Not technical) what's the history behind all your bowties?

**A:** bowties are cool! I don't know if there's a history there, I just like them

---

**Q:** Thoughts on graphql-compose? https://github.com/nodkz/graphql-compose
...
**Q:** You wake up next week and for one reason or another, you no longer work at Facebook... What sort of project(s) would you start working on?
...
**Q:** I noticed you've done some work on errors in graphql-js recently. Do you have a preferred way of formatting errors so that they can be parsed and displayed to users?
...
**Q:** Lee, can you give us a direction on this issue so we can implement the PR that can be accepted in the official express-graphql repository. http://github.com/graphql/express-graphql/issues/101
...
**Q:** How do you manage schema duplication between your graphql layer and backing services at FB? i find myself effectively declaring all of my object schemas twice now that i'm using graphql
...
**Q:** What technology do you use for subscribing outside of graphql for subscriptions?

**A:** We have a custom pubsub service we built at Facebook for that

---

**Q:** Are there any interesting projects in use or under development at Facebook that are not currently open sourced?*
...
**Q:** Do you have any thoughts on how GraphQL would work in a microservices architecture? In particular, I'm curious about having a single GraphQL microservice vs having a GraphQL endpoint per microservice.
...
**Q:** What do you think about relay v apollo for web apps/react native apps?
