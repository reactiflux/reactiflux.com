...
**Q:** What is your opinion on using context api? – zend
...
**Q:** How did you get started with with development? – Gabe
...
**Q:** What is that cool UI you posted of GitHub history? – devsnek

**A:** https://GitHub-contributions.now.sh/

---

**Q:** Where in the priority list is async SSR for after.js once React implements it? – lokiiarora

**A:** Very very high.

---

**Q:** How would you recommend someone move from intermediate/advanced React developer into expert? Learning strategy or path ? – jhorwitz
...
**Q:** Do have any caching strategies for Razzle? Any code splitting for Razzle? – Nima_arf
...
**Q:** What is your favourite project and why? – AdrianC

**A:** I don't if I have a favorite! Probably Formik or Razzle because I find them so useful in my day job.

---

**Q:** You really have a lot of React projects in your account, but how do you keep doing more and more projects by yourself and still doing your daily job? – leandrorr
...
**Q:** What are some of the areas React can learn from the competition? – lokiiarora
...
**Q:** What do you think about the future of native apps? Do you think it will be defeated by the web with tech like webassembly? – lasagnelennart
...
**Q:** Best advice for student developers to "get out there" and make connections? And hello from NJ :stuck_out_tongue: – Andrew
...
**Q:** What's your favorite source of React learning? – leandrorr
...
**Q:** Talking about magic... What do you think about Relay?? – AdrianC
...
**Q:** Do you think it's good idea to migrate from Razzle to After.js? – Nima_arf
...
**Q:** What kind of stuff do you do at The Palmer Group? – Andrew
...
**Q:** What is your favorite technical book?? – AdrianC
...
**Q:** Any tips for React, Redux beginners? – Arun
...
**Q:** What frustrates you the most about React applications? What best practice do you wish existed for everyone? – EvHaus

**A:** I wish everyone could use the codegen tool that we have. Testing data fetching used to be such a pain. Now it's not.

---

**Q:** What codegen tool? – jk
...
**Q:** What is the most exciting thing you would learn now if you had time? – PeterM
...
**Q:** What is your favorite technical stack?? – AdrianC
...
**Q:** What's the engineering culture like at Palmer that other companies can learn from? Having Fridays to work on Open Source is awesome. – hehexd
...
**Q:** If you need to make a back end for your React project, what would be your back end framework and your plan, how would you go about making a back end? – Nola1222
...
**Q:** What non technical skill/thing you think is the most important in tech? – PeterM

**A:** Be a mensch (a person of integrity and honor).

---

**Q:** It seems like Mongo is a crime to use these days if you mention it. What are some things for people who are skeptical to know and consider before using it? – Sonicrida
...
**Q:** When will you open source your codegen tool? – zend
