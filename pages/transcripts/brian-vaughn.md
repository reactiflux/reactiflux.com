...
**Q:** Hi Brian! Can you tell us more on how Facebook handles complex forms internally with React
...
**Q:** Maybe to specific, but hoping to get some insights 'Does facebook has a .js with global variables to use..?'
...
**Q:** Where can I read more about this configuration modules?
...
**Q:** Maybe you have better solution how to pass event handlers to child components instead writing onSomething props.
...
**Q:** What led to the creation of react-virtualized and how did you go about writing the lib?
...
**Q:** My team used react virtualized for a complex form with lots of line items and rendering slow, but she had a hard time figuring out how to implement a custom form to improve render time using react virtualized.
...
**Q:** Classic QA question for you: what's been your biggest challenge since joining Facebook and the React team?
...
**Q:** I've heard conflicting information about react fiber's performance...  can we expect a speed boost or not?
...
**Q:** How does the internal feature development cycle work @ Facebook?
...
**Q:** What build tools using for build facebook apps?
...
**Q:** What are your quick thoughts on dynamic row/cell dimensions in virtualized scrolling? Is there a widely accepted elegant solution for this dilemma?
...
**Q:** What do you think about the React IDE project ?

**A:** React IDE looks cool. I've never used it. I will download it and try it after this Q&A

---

**Q:** What you all preferred to choose between react-thunk or react-saga .?
...
**Q:** What is the direction of Reason and OCaml within Facebook? Will Reason have an effect on React in the future?
...
**Q:** Brian, tell us about yourself. How long have you been coding? What was your first programming language? Highlights or milestones of your career/life?
...
**Q:** What specifically do you hope to contribute to React based on your past experience and skills?
...
**Q:**  I am new in react so I have one question which is best among react-toolbox & material -ui for material  design web apps? There was some very tricky to set the theme change in react-toolbox . Is there any suggestions to how I manage if you prefer react-toolbox
...
**Q:** So... In facebook apps (in new apps) are you using something like CSS Modules? What approach for managing CSS you can advice?
...
**Q:** Do you feel pressure from having to maintain such a popular open source library?
...
**Q:** Was there any talk at Facebook about possibility of 'native' implementation of React (or just JSX) in browsers?

**A:** WRT talk about "native" React in a browser- Not to my knowledge.

---

**Q:** Is Facebook working on something for the backend ?
...
**Q:** What are you most interested in now? And why?
...
**Q:** Maybe you know, but it is short question. What about RN for desktops? Any plans to support RN for desktop by fb team?
...
**Q:** As someone new to JS and frameworks, the amount of frameworks and the speed of their decline makes choosing absolutely daunting. What do you think of the future for React?
...
**Q:** What does Facebook get out of open-sourcing React and React Native?
...
**Q:** Would React be able to take advantage of web assembly, and if so to your knowledge is there anything in pipeline?
...
**Q:** What is the most common full stack for React? (Backend, DB) etc. And where is a good free tutorial?
...
**Q:** Where do you go for best practices/etc when using React/Redux/etc? Any particular gems?
...
**Q:** What is the biggest challenge/problem you are facing now?
...
**Q:** What are you interests beyond Javascript? Anything that you would recommend people take a look at?
...
**Q:** Will yarn continue to be maintained if (or when) npm catches up in terms of features? did you notice a drive to unify the ecosystem in that regard at facebook?

**A:** Yes! Yarn is being actively developed both internally and in the community :) We love it!

---

**Q:** How do I get a job at facebook (react team) ? and do you also drive a tesla ?
...
**Q:** Filler questions yay or nay: semicolons? mechanical keyboards? spaces over tabs?
...
**Q:** What code conventions are you using for js at FB and will you be publishing that like airbnb has?
...
**Q:** When hiring, does Facebook emphasize more on education or contributions?
