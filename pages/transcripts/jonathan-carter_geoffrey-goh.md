...
**Q:** Can you go into some of the unique ideas of the React Native extension for Visual Studio Code  
...
**Q:** Any plans for typescript support to react native ??(edited)  
...
**Q:** Is there wizard incoming for facilitating getting started on React Native on Windows OS? Getting started takes most of the time in React Native as developer on Window OS  
...
**Q:** Without having too much experience using Codepush, I'd still like to know: are there any immediate drawbacks of pushing app updates outside of Apple's ecosystem (app store)?  
...
**Q:** Am I alone feeling like React Native Upgrade does not helps as much as I'd like (I mean loosing images assets...)? Upgrade is like init a new project and just keep my js app.  
...
**Q:** any thoughts on integrating something like hot module reload to CodePush so the app doesn't have to be quit for CodePush to update?  
...
**Q:** any plans to interpret flow metadata to typescript just like closure ??  
...
**Q:** Any plan or thoughts about building a GUI for Codepush or maybe integrating with VSCode in addition to the current CLI?  
...
**Q:** Is there a way to track a crash that causes automatic rolbacks? For clarity — i generally have at least 1 or 2 rollbacks per update, but all of the others are successful  
...
**Q:** what are the general causes of rollbacks? failure to replace the jsbundle?  
...
**Q:** How long you will work in this project? 😄  
...
**Q:** Not sure if this was answered before but, what was the motive behind creating CodePush? Is there an internal Microsoft project that needed this system and then decided to open source it?  
...
**Q:** Tangential: when will vscode have tab support in the wild (not internal)?  
...
**Q:** I'm curious how many of the [React Native dev issues expressed here](https://blog.addjam.com/react-native-its-not-all-sugar-and-spice-cb5d6b25eae9#.ulccsdqne) are on Microsoft's radar for IDE improvement.  
...
**Q:** Just a tangential suggestion...to float the idea to the Xamarin team to offer React rendering as an alternative to XAML. 😍  
...
**Q:** Is there a site of information where I can find out more about this? Jumped in a bit late  
...
**Q:** really interested in Code Push, how much longer do you guys plan to stay in beta ?  
...
**Q:** What exactly are the rules for whether a code push release gets picked up by a react-native app? Does it have to have the same semver as the compiled native version?  
...
**Q:** Ok gotcha. So if I release to App Store with 1.0.1, and I want to make sure that fresh installs don't redownload anything, what codepush semver should I avoid?  
